...
export default function Chatbot() {
  ...
  const [open, setOpen] = useState(false); // ✅ Toggle state for dropdown
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50">
      ...
      {open && (
        <div
          className="w-96 h-[450px] bg-white shadow-2xl rounded-2xl p-4 border border-gray-300 flex flex-col mb-3 
